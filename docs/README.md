...
| [45-bahnhoefe-auf-dem-telefon.md](45-bahnhoefe-auf-dem-telefon.md) | build 20 | The station extract `.vst`, byte by byte: what the phone reads instead of asking, how it is published and how the format grows |
