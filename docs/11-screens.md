...
- Badges as a grid of Johannes' achievement artwork (`app/assets/achievements/<stem>-aktiv|inaktiv.png`, a red ring with the motif when earned, grey when not; `tools/badge_icons.sh` makes the ground transparent and trims new files), names visible under every tile (the museum is part of the fun). A tap opens the badge sheet with the artwork large, the rule and the date. 21 badges: the 14 moments (first delay, SEV, Stellwerksstörung, …) and the minute ladder 1.000 · 2.000 · 4.000 · 8.000 · 16.000 · 32.000 · 64.000 Verspätungsminuten, awarded by the backend when a ride's finalisation lifts the total past a step. The arrival screen shows a new badge with its artwork, once.
