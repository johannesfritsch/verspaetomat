...
const datenschutz = LegalDoc(
  ...
  eyebrow: 'Rechtliches',
  title: 'Datenschutz',
  lead: 'Was wir speichern, warum, wie lange, und was du jederzeit selbst löschen kannst. Kurz: kein Konto, kein Tracking, keine Werbung. Wo du bist, erfahren wir an einer einzigen Stelle — beim Einchecken, weil du es uns dort mitschickst.',
  stand: 'Stand: 22. September 2026',
  sections: [
    ...
    LegalSection('Standort', [
      ...
      'Auch im Hintergrund fragt die App niemanden, welche Bahnhöfe hier sind: Sie schlägt in demselben Verzeichnis nach, das sie ohnehin dabeihat. Für den Hinweis am Bahnhof verlässt damit nichts dein Telefon — keine Position, keine Kennung, keine Anfrage. Auch nicht während einer Fahrt, und auch nicht, wenn dein Telefon neu sortiert, welche Bahnhöfe es beobachtet. Früher ging diese Frage an unseren Server, auf einer längeren Fahrt mehrmals in der Stunde; seit das Verzeichnis auf dem Telefon liegt, entfällt sie.',
      'Während der Fahrt folgen wir dem Zug in den Fahrplandaten, nicht deinem Telefon.',
      'Bei Dritten landet davon nichts: Seit das Bahnhofsverzeichnis bei uns liegt, bekommt kein anderer Dienst deine Koordinaten zu sehen. Bei uns landet eine Position nur noch an einer einzigen Stelle: beim Einchecken, wo sie an dieser Fahrt hängt und mit ihr verschwindet. Standortverläufe führen wir nicht.',
    ...
    LegalSection('Dienstleister', [
      'Fahrplan- und Verspätungsdaten: Transitous (transitous.org), ein offener Dienst auf Basis öffentlicher Fahrplandaten. Er bekommt die Zugabfragen unseres Servers, keine Kennung von dir und keine Position. Das Verzeichnis der Bahnhöfe liegt bei uns: Wir übernehmen es aus den Fahrplandaten von DELFI e.V. und des VBB (Lizenz CC BY 4.0, bezogen über Transitous) und halten es selbst vor. Die App hat dieses Verzeichnis dabei und beantwortet „Bahnhöfe in der Nähe“ und die Bahnhofssuche damit auf dem Telefon — im Vordergrund wie im Hintergrund. Wo du bist, erfährt außer dir nur unser Server, und nur die eine Position, die du beim Einchecken selbst mitschickst.',
...
const bote = LegalDoc(
  ...
  sections: [
    ...
    LegalSection('Jede Antwort ganz', [
      'Alles, was an deine Verspätomat-Adresse kommt, leiten wir vollständig und unverändert an deine private E-Mail-Adresse weiter. In der App zeigen wir dieselbe Mail. Eine Software erkennt darin nur, welche Fahrten bezahlt oder abgelehnt sind, den genannten Betrag und ob eine Rückfrage kommt, damit dein Konto stimmt. Ist sie sich nicht sicher, zählt nichts, bis die Antwort eindeutig ist.',
      'Antworten auf Rückfragen schreibst du selbst, in der App oder aus deinem E-Mail-Programm. Wir bieten Textvorschläge an, abgeschickt wird nur, was du abschickst.',
    ]),
