...
const datenschutz = LegalDoc(
  ...
  sections: [
    ...
    LegalSection('Dienstleister', [
      'Fahrplan- und Verspätungsdaten: Transitous (transitous.org), ein offener Dienst auf Basis öffentlicher Fahrplandaten. Er bekommt die Zugabfragen unseres Servers, keine Kennung von dir und keine Position. Das Verzeichnis der Bahnhöfe liegt bei uns: Wir übernehmen es aus den Fahrplandaten von DELFI e.V. und des VBB (Lizenz CC BY 4.0, bezogen über Transitous) und halten es selbst vor. „Bahnhöfe in der Nähe" und die Bahnhofssuche beantwortet unser Server aus diesem Verzeichnis, ohne jemanden zu fragen.',
