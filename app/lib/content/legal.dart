...
const datenschutz = LegalDoc(
  ...
  sections: [
    ...
    LegalSection('Standort', [
      ...
      'Während der Fahrt folgen wir dem Zug in den Fahrplandaten, nicht deinem Telefon. Es gibt keine Standortverläufe und keine Standortnutzung im Hintergrund. Ohne Standortfreigabe funktioniert die App vollständig; du wählst den Bahnhof dann selbst.',
