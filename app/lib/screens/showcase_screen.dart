      ...
      child: Column(
        ...
        children: [
          ...
          _group(context, 'Der Weg eines Fahrgasts', isLocal: isLocal, [
            ...
            const _Entry('Wähle einen Verein', 'Setup 1 · Zweck', Routes.zweckWaehlen, demoOnly: true),
            const _Entry('Sollen wir uns melden?', 'Setup 2 · Mitteilungen', Routes.permissions, demoOnly: true),
            const _Entry('Am Bahnsteig erinnern?', 'Setup 3 · Standort', Routes.standort, demoOnly: true),
            const _Entry('Fast geschafft', 'Setup 3 · „Immer"', Routes.standortImmer, demoOnly: true),
            ...
            _Entry('Angekommen +14', 'kein Anspruch, Punkte', '${Routes.angekommen}?variant=14', demoOnly: true),
            _Entry('Angekommen +59', 'um eine Minute', '${Routes.angekommen}?variant=59', demoOnly: true),
            _Entry('Angekommen, Ausfall', 'Reise nicht angetreten', '${Routes.angekommen}?variant=ausfall', demoOnly: true),
            _Entry('Angekommen, keine Daten', 'selbst eingetragen', '${Routes.angekommen}?variant=nodata', demoOnly: true),
          ]),
          const VGap.l(),
          _group(context, 'Konto und Antrag', isLocal: isLocal, [
            const _Entry('Anträge', 'Sammeln, unterwegs, beantwortet', Routes.antraege),
            ...
            _Entry('Antrag', 'fünf Schritte, Servicecenter', '${Routes.antrag}?desk=Servicecenter%20Fahrgastrechte', demoOnly: true),
            _Entry('Antrag, unbekannter Betreiber', 'Adresse fehlt', '${Routes.antrag}?desk=Unbekannt', demoOnly: true),
            _Entry('Antwort: angenommen', 'Post vom Servicecenter', '${Routes.antwort}?mail=m-0718-in', demoOnly: true),
            _Entry('Antwort: Rückfrage', 'Ticketkopie nachreichen', '${Routes.antwort}?demo=question', demoOnly: true),
            _Entry('Antwort: abgelehnt', 'außergewöhnliche Umstände', '${Routes.antwort}?demo=rejected', demoOnly: true),
            const _Entry('Nachtrag', 'gestern vergessen', Routes.nachtrag),
            ...
            const _Entry('Vorführung', 'der ganze Antrag, ohne zu senden', Routes.vorfuehrung),
          ]),
          const VGap.l(),
          _group(context, 'Wir und Ich', isLocal: isLocal, [
            const _Entry('Wir', 'Community, Vereine, Ranglisten', Routes.wir),
            _Entry('Zweck', 'Bahnhofsmission Köln', '${Routes.zweck}?id=bahnhofsmission'),
            const _Entry('Ich', 'Profil, Abzeichen', Routes.ich),
            const _Entry('Alle Fahrten', 'Historie', Routes.historie),
            const _Entry('Einstellungen', 'und Datenschutz', Routes.einstellungen),
            const _Entry('Woher kommen die Daten?', 'die Tabelle', Routes.datenherkunft),
            const _Entry('Störung', 'wenn der Server nicht erreichbar ist', Routes.stoerung),
            const _Entry('Zaunkarte', 'wie die Zäune stehen', Routes.zaunkarte),
          ]),
          const VGap.xl(),
          if (!isLocal) ...[
